...
from isValidSudoku.main import verifHorLine, verifVerLine, verifBlock
...
class TestIsValidSudokuFun:
    ...
    def test_valid_v_line_2(self):
        ...
        assert not verifVerLine(board, 8)
    ...
    def test_valid_v_line_3(self):
        ...
        assert not verifVerLine(board, 0)
    ...
    def test_valid_block_2(self):
        board = [["5", "3", "3", ".", "7", ".", ".", ".", "."]
            ...
            , [".", ".", ".", "4", "1", "9", ".", ".", "5"]
            , [".", ".", ".", ".", "8", ".", ".", "7", "9"]]
        assert not verifBlock(board, 0, 0)
